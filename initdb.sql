...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_estoque` (`idEstoque` INT, `Fornecedor` INT, `Produto` INT, `Quant` INT, `un` INT, `un2` INT, `Caixas M2` INT, `Caixas PÇ` INT, `Cód Com` INT, `Status` INT);
