...
CREATE TABLE IF NOT EXISTS `mydb`.`Cadastro_has_Endereco` (
  ...
  PRIMARY KEY (`Cadastro_idCadastro`, `Endereco_idEndereco`),
  INDEX `fk_Cadastro_has_Endereco_Endereco1_idx` (`Endereco_idEndereco` ASC),
  INDEX `fk_Cadastro_has_Endereco_Cadastro1_idx` (`Cadastro_idCadastro` ASC),
...
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`) VALUES (6, NULL, '06543-260', 'Rua Cerejeira', '956', NULL, 'Condomínio Melville (Tamboré)', 'Santana de Parnaíba', 'SP', 1);
...
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `pfpj`) VALUES (3, 'CLIENTE', 'Eduardo Pinto de Oliveira', NULL, NULL, '116.875.908-00', '11.111.111/1111-11', 'Staccato Revestimentos', NULL, 'isento', '(11)4153-0948', NULL, NULL, NULL, NULL, 'edu.oliv@globo.com', 1, NULL, NULL, 0, 'PF');
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `pfpj`) VALUES (4, 'CLIENTE', 'Zé', NULL, NULL, '927.636.342-49', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cadastro_has_Endereco` (`Cadastro_idCadastro`, `Endereco_idEndereco`) VALUES (3, 6);
INSERT INTO `mydb`.`Cadastro_has_Endereco` (`Cadastro_idCadastro`, `Endereco_idEndereco`) VALUES (1, 1);
INSERT INTO `mydb`.`Cadastro_has_Endereco` (`Cadastro_idCadastro`, `Endereco_idEndereco`) VALUES (1, 2);
INSERT INTO `mydb`.`Cadastro_has_Endereco` (`Cadastro_idCadastro`, `Endereco_idEndereco`) VALUES (1, 3);
INSERT INTO `mydb`.`Cadastro_has_Endereco` (`Cadastro_idCadastro`, `Endereco_idEndereco`) VALUES (2, 7);
