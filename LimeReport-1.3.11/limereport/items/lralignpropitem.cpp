...
namespace {
LimeReport::ObjectPropItem *createAlignItem(QObject *object, LimeReport::ObjectPropItem::ObjectsList *objects,
...
AlignmentPropItem::AlignmentPropItem(QObject *object, ObjectsList *objects, const QString &name,
  ...
  m_horizEditor =
      new AlignmentItemEditor(object, objects, name, tr("horizontal"), value.toInt(), this, false, m_horizMap);
