...
CREATE TABLE IF NOT EXISTS `mydb`.`loja` (
  ...
  `portaACBr` INT(11) NOT NULL DEFAULT '3436',
  `pastaEntACBr` VARCHAR(100) NOT NULL DEFAULT 'C:/ACBrNFeMonitor/ENTNFE.TXT/',
  `pastaSaiACBr` VARCHAR(100) NOT NULL DEFAULT 'C:/ACBrNFeMonitor/SAINFE.TXT/',
  `pastaXmlACBr` VARCHAR(100) NOT NULL DEFAULT 'C:/ACBrNFeMonitor/XML/',
  `servidorSMTP` VARCHAR(100) NULL,
  `portaSMTP` VARCHAR(100) NULL,
  `emailCompra` VARCHAR(100) NULL,
  `emailSenha` VARCHAR(100) NULL,
  `pastaCompra` VARCHAR(100) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`alcadas` (
  ...
  `cheque` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
  `dinheiro` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
  `boleto` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `mydb`.`orcamento` (
  ...
  `data` DATETIME NOT NULL,
  `subTotalBru` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
  `subTotalLiq` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
  `frete` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
  `descontoPorc` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
  `descontoReais` DECIMAL(15,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `mydb`.`orcamento_has_produto` (
  ...
  `prcUnitario` DECIMAL(15,2) NOT NULL,
  `caixas` INT(11) NOT NULL,
  `quant` DECIMAL(15,2) NOT NULL,
  `un` VARCHAR(45) NOT NULL,
  `unCaixa` DECIMAL(15,2) NOT NULL,
  `codComercial` VARCHAR(100) NOT NULL,
  `formComercial` VARCHAR(100) NOT NULL,
  `parcial` DECIMAL(15,2) NOT NULL,
  `desconto` DECIMAL(15,4) NOT NULL DEFAULT '0.0000',
  `parcialDesc` DECIMAL(15,2) NOT NULL,
  `descGlobal` DECIMAL(15,2) NOT NULL,
  `total` DECIMAL(15,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`estoque` (
  ...
  `quant` DECIMAL(15,2) NULL DEFAULT NULL,
