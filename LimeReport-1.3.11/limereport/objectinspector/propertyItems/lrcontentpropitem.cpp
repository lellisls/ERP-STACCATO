...
namespace {
LimeReport::ObjectPropItem *createContentPropItem(QObject *object, LimeReport::ObjectPropItem::ObjectsList *objects,
...
bool registredContentProp = LimeReport::ObjectPropFactory::instance().registerCreator(
...
void ContentEditor::editButtonClicked() {
  ...
  // dialog->setGeometry(QStyle::alignedRect(Qt::LeftToRight, Qt::AlignCenter, dialog->size(),
  ...
  connect(editor, &QObject::destroyed, this, &ButtonLineEditor::editingFinished);
  dialog->exec();
}
