...
inline bool initDb() {
  ...
  if (not query.exec("SELECT log_logradouro.log_tipo_logradouro, log_logradouro.log_no as logradouro, "
                     "log_bairro.bai_no as bairro, log_localidade.loc_no as cidade, log_localidade.ufe_sg as uf, "
                     "log_logradouro.cep FROM cep.`log_logradouro`, cep.`log_localidade`, cep.`log_bairro` WHERE "
                     "log_logradouro.loc_nu_sequencial = log_localidade.loc_nu_sequencial AND "
                     "log_logradouro.bai_nu_sequencial_ini = log_bairro.bai_nu_sequencial AND log_logradouro.cep = "
                     "12245500;")) {
