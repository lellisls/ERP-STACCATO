...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Loja` (`idLoja`, `idEndereco`, `descricao`, `nomeFantasia`, `razaoSocial`, `tel`, `inscEstadual`, `sigla`, `cnpj`, `codUF`, `porcentagemFrete`, `valorMinimoFrete`) VALUES (1, 5, 'Loja 1', 'LOJA 01', 'LOJA 01 EPP', '(12)1234-5678', '000.000.000.000', 'LJ01', '19.261.391/0001-26', 35, NULL, NULL);
...
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `pfpj`) VALUES (3, 'CLIENTE', 'Eduardo Pinto de Oliveira', NULL, NULL, '116.875.908-00', '11.111.111/1111-11', 'Staccato Revestimentos', NULL, 'isento', '(11)4153-0948', NULL, NULL, NULL, NULL, 'edu.oliv@globo.com', NULL, NULL, NULL, 0, 'PF');
