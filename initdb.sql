...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCliente`) VALUES (1, 'Não há', '', '', '', '', '', '', '', 1, NULL);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCliente`) VALUES (2, 'END. PAGAMENTO', '17521-270', 'Rua Antônio Asperti', '658', 'AP 1', 'Jardim Esplanada', 'Marília', 'SP', 1, 1);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCliente`) VALUES (3, 'END. ENTREGA', '54230-586', 'Rua Santa Ana', '14', '', 'Ur-06', 'Jaboatão dos Guararapes', 'PE', 1, 1);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCliente`) VALUES (4, 'END. FATURAMENTO', '88813-900', 'Av. Manoel D. Freitas', '1001', '', 'PROSPERA', 'Criciúma', 'SC', 1, 1);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCliente`) VALUES (5, 'END. LOJA', '12233-000', 'Av. Andrômeda', '3752', '', 'Bosque dos Eucaliptos', 'São José dos Campos', 'SP', 1, NULL);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCliente`) VALUES (6, 'RESIDENCIA', '06543-260', 'Rua Cerejeira', '956', '', 'Condomínio Melville (Tamboré)', 'Santana de Parnaíba', 'SP', 1, 3);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCliente`) VALUES (7, 'END. FATURAMENTO', '87114-250 ', 'Avenida da Laguna', '1776', '', 'Jardim Independência III', 'Sarandi', 'PR', 1, 2);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Loja_has_Endereco` (`idEndereco`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idLoja`) VALUES (1, 'Loja', '06473-000', 'Avenida Andrômeda', '900', NULL, 'Alphaville Empresarial', 'Barueri', 'SP', 1, NULL);
