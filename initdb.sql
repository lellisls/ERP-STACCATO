...
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCadastro`) VALUES (3, 'END. ENTREGA', '54230-586', 'Rua Santa Ana', '14', NULL, 'Ur-06', 'Jaboatão dos Guararapes', 'PE', 1, 1);
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCadastro`) VALUES (4, 'END. FATURAMENTO', '88813-900', 'Av. Manoel D. Freitas', '1001', NULL, 'PROSPERA', 'Criciúma', 'SC', 1, 1);
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCadastro`) VALUES (5, 'END. LOJA', '12233-000', 'Av. Andrômeda', '3752', NULL, 'Bosque dos Eucaliptos', 'São José dos Campos', 'SP', 1, NULL);
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCadastro`) VALUES (6, 'RESIDENCIA', '06543-260', 'Rua Cerejeira', '956', NULL, 'Condomínio Melville (Tamboré)', 'Santana de Parnaíba', 'SP', 1, 3);
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `ativo`, `idCadastro`) VALUES (7, 'END. FATURAMENTO', '87114-250 ', 'Avenida da Laguna', '1776', NULL, 'Jardim Independência III', 'Sarandi', 'PR', 1, 2);
