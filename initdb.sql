...
CREATE TABLE IF NOT EXISTS `mydb`.`PedidoFornecedor` (
  ...
  INDEX `fk_Orcamento_Profissional1_idx` (`idProfissional` ASC),
  INDEX `fk_PedidoFornecedor_Fornecedor1_idx` (`idFornecedor` ASC),
  INDEX `fk_PedidoFornecedor_Fornecedor2_idx` (`idFornecedor` ASC),
  ...
  CONSTRAINT `fk_Orcamento_Profissional110`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PedidoFornecedor_Fornecedor1`
    FOREIGN KEY (`idFornecedor`)
    REFERENCES `mydb`.`Fornecedor` (`idFornecedor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PedidoFornecedor_Fornecedor2`
    FOREIGN KEY (`idFornecedor`)
    REFERENCES `mydb`.`Fornecedor` (`idFornecedor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`NFe` (
  ...
  `idVenda` VARCHAR(20) NULL,
  `idLoja` INT UNSIGNED NOT NULL,
  `status` VARCHAR(45) NOT NULL DEFAULT 'PENDENTE',
  `chaveAcesso` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`idNFe`, `idLoja`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`NFe_has_Itens` (
  ...
  PRIMARY KEY (`item`, `idNFe`, `idLoja`),
  CONSTRAINT `fk_NFe_has_Itens_NFe1`
    FOREIGN KEY (`idNFe` , `idLoja`)
    REFERENCES `mydb`.`NFe` (`idNFe` , `idLoja`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ViewVendas` (`idVenda` INT, `idLoja` INT, `idUsuario` INT, `idCliente` INT, `idEnderecoEntrega` INT, `idProfissional` INT, `data` INT, `subTotalBru` INT, `subTotalLiq` INT, `frete` INT, `descontoPorc` INT, `descontoReais` INT, `total` INT, `validade` INT, `status` INT);
