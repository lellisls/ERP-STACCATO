...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ViewVendas` (`idVenda` INT, `idLoja` INT, `idUsuario` INT, `idCliente` INT, `idEnderecoEntrega` INT, `idProfissional` INT, `data` INT, `total` INT, `desconto` INT, `frete` INT, `validade` INT, `status` INT);
