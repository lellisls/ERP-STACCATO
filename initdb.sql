...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `pfpj`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`) VALUES (1, 'PJ', 'AMBOS', 'Marcos Oliveira Ferreira', 'Marcos', '41.875.789-6', '432.432.477-80', '00.696.325/0001-50', 'Betina e Isabelle Alimentos ME', 'Bisa Massas', '920.048.586.200', '(11)2801-2013', '(11)2801-2013', '(11)2801-2013', '00*0000000*00000', '(11)2801-2013', 'LucasSousaRibeiro@teleworm.us ', NULL, NULL, NULL, 0);
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `pfpj`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`) VALUES (2, 'PJ', 'FORNECEDOR', 'Portinari', 'Portinari', '00.000.000-6', '000.000.000-80', '00.334.497/0001-84', 'CERAMICA PORTINARI S/A', 'Portinari', 'ISENTO', '(48)3431-6333', NULL, NULL, NULL, NULL, 'contato@ceramicaportinari.com.br', NULL, NULL, NULL, 0);
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `pfpj`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`) VALUES (3, 'PJ', 'CLIENTE', 'Eduardo Pinto de Oliveira', NULL, NULL, '116.875.908-00', '11.111.111/1111-11', 'Staccato Revestimentos', NULL, 'isento', '(11)4153-0948', NULL, NULL, NULL, NULL, 'edu.oliv@globo.com', 1, NULL, NULL, 0);
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `pfpj`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`) VALUES (4, 'PF', 'CLIENTE', 'Zé', NULL, NULL, '927.636.342-49', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
