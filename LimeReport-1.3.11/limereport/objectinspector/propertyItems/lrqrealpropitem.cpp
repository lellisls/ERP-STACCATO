...
namespace {
LimeReport::ObjectPropItem *createQRealPropItem(QObject *object, LimeReport::ObjectPropItem::ObjectsList *objects,
...
bool registred = LimeReport::ObjectPropFactory::instance().registerCreator(LimeReport::APropIdent("qreal", ""),
                                                                           QObject::tr("qreal"), createQRealPropItem);
bool registredDouble = LimeReport::ObjectPropFactory::instance().registerCreator(
