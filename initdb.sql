...
CREATE TABLE IF NOT EXISTS `mydb`.`Endereco` (
  ...
  `used` VARCHAR(45) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Cadastro` (
  ...
  FULLTEXT INDEX `idxFT` (`nome` ASC, `apelido` ASC, `razaoSocial` ASC, `nomeFantasia` ASC),
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (1, 'Nenhum', 'Nenhum', 'Nenhum', 'Nenhum', 'Nenhum', 'Nenhum', 'Nenhum', 'Nenhum', '0');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Profissional` (`idProfissional`, `nome`, `tipo`, `tel`, `email`, `banco`, `agencia`, `cc`, `cp`) VALUES (1, 'Nenhum', 'Nenhum', '', '', NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `tipo`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `idEnderecoFaturamento`, `idEnderecoCobranca`, `idEnderecoEntrega`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `tipoPessoa`) VALUES (1, 'AMBOS', 'Marcos Oliveira Ferreira', 'Marcos', '41.875.789-6', '432.432.477-80', '00.696.325/0001-50', 'Betina e Isabelle Alimentos ME', 'Bisa Massas', '920.048.586.200', 1, 2, 3, '(11)2801-2013', '(11)2801-2013', '(11)2801-2013', '00*0000000*00000', '(11)2801-2013', 'LucasSousaRibeiro@teleworm.us ', 1, NULL, NULL, NULL, 'PJ');
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `tipo`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `idEnderecoFaturamento`, `idEnderecoCobranca`, `idEnderecoEntrega`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `tipoPessoa`) VALUES (2, 'FORNECEDOR', 'Portinari', 'Portinari', '00.000.000-6', '000.000.000-80', '00.334.497/0001-84', 'CERAMICA PORTINARI S/A', 'Portinari', 'ISENTO', 4, 4, 4, '(48)3431-6333', NULL, NULL, NULL, NULL, 'contato@ceramicaportinari.com.br', NULL, NULL, NULL, NULL, 'PJ');
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `tipo`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `idEnderecoFaturamento`, `idEnderecoCobranca`, `idEnderecoEntrega`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `tipoPessoa`) VALUES (3, 'CLIENTE', 'Eduardo Pinto de Oliveira', NULL, NULL, '116.875.908-00', '11.111.111/1111-11', 'Staccato Revestimentos', NULL, 'isento', 6, 6, 6, '(11)4153-0948', NULL, NULL, NULL, NULL, 'edu.oliv@globo.com', NULL, NULL, NULL, NULL, 'PF');
