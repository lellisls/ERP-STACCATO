...
public:
  ...
  ScriptEngineNode *addChild(const QString &name = "", const QString &description = "", NodeType type = Root,
...
public:
  ...
  QScriptValue addFunction(const QString &name, QScriptEngine::FunctionSignature function, const QString &category = "",
                           const QString &description = "");
  QScriptValue addFunction(const QString &name, const QString &script, const QString &category = "",
                           const QString &description = "");
...
public:
  explicit QFontPrototype(QObject *parent = nullptr) : QObject(parent), QScriptable() {
