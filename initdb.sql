...
CREATE TABLE IF NOT EXISTS `mydb`.`produto_has_estoque` (
  ...
  `quant` DECIMAL(15,2) NULL COMMENT '',
  `idNFe` VARCHAR(45) NULL COMMENT '',
  `xml` MEDIUMTEXT NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `mydb`.`estoque` (
  ...
  `quant` DECIMAL(15,2) NULL DEFAULT NULL COMMENT '',
  `un` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `m2cx` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `pccx` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `kgcx` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
