...
bool registredQRect =
    LimeReport::XMLAbstractSerializatorFactory::instance().registerCreator("QRect", createQRectSerializator);
bool registredQRectF =
    LimeReport::XMLAbstractSerializatorFactory::instance().registerCreator("QRectF", createQRectSerializator);
}
...
QVariant LimeReport::XMLQRectSerializator::loadValue() {
  ...
  rect = QRect(m_node->attribute("x").toInt(), m_node->attribute("y").toInt(), m_node->attribute("width").toInt(),
