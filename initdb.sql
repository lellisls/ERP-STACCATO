...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_venda` (`Código` INT, `Loja` INT, `Vendedor` INT, `Cliente` INT, `Data` INT, `Total R$` INT, `Status` INT, `Dias restantes` INT);
