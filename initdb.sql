...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Loja` (`idLoja`, `idEndereco`, `descricao`, `nomeFantasia`, `razaoSocial`, `tel`, `inscEstadual`, `sigla`, `cnpj`, `codUF`, `porcentagemFrete`, `valorMinimoFrete`) VALUES (1, 5, 'Alphaville', 'Staccato', 'STACCATO REVESTIMENTOS COMÉRCIO E REPRESENTAÇÃO LTDA', '(11)4191-9816', '206.257.840.114', 'ALPH', '09.375.013/0001-10', 35, 4, 80);
