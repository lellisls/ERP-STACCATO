...
CREATE TABLE IF NOT EXISTS `mydb`.`Endereco` (
  ...
  `uf` VARCHAR(45) NULL,
  `used` VARCHAR(45) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Cadastro` (
  ...
  `idEnderecoCobranca` INT UNSIGNED NULL,
  ...
  INDEX `fk_Cadastro_Endereco1_idx` (`idEnderecoFaturamento` ASC),
  INDEX `fk_Cadastro_Endereco2_idx` (`idEnderecoCobranca` ASC),
  INDEX `fk_Cadastro_Endereco3_idx` (`idEnderecoEntrega` ASC),
  ...
  CONSTRAINT `fk_Cadastro_Endereco1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cadastro_Endereco2`
    FOREIGN KEY (`idEnderecoCobranca`)
    REFERENCES `mydb`.`Endereco` (`idEndereco`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cadastro_Endereco3`
...
CREATE TABLE IF NOT EXISTS `mydb`.`Venda_has_Pagamento` (
  `Venda_idVenda` VARCHAR(20) NOT NULL,
  `Venda_idLoja` INT UNSIGNED NOT NULL,
  `Pagamento_idPagamento` INT NOT NULL,
  PRIMARY KEY (`Venda_idVenda`, `Venda_idLoja`, `Pagamento_idPagamento`),
  INDEX `fk_Venda_has_Pagamento_Pagamento1_idx` (`Pagamento_idPagamento` ASC),
  INDEX `fk_Venda_has_Pagamento_Venda1_idx` (`Venda_idVenda` ASC, `Venda_idLoja` ASC),
  CONSTRAINT `fk_Venda_has_Pagamento_Venda1`
    FOREIGN KEY (`Venda_idVenda` , `Venda_idLoja`)
    REFERENCES `mydb`.`Venda` (`idVenda` , `idLoja`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (1, 'Não há', '', '', '', '', '', '', '', '0');
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (2, 'END. PAGAMENTO', '17521-270', 'Rua Antônio Asperti', '658', 'AP 1', 'Jardim Esplanada', 'Marília', 'SP', '0');
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (3, 'END. ENTREGA', '54230-586', 'Rua Santa Ana', '14', NULL, 'Ur-06', 'Jaboatão dos Guararapes', 'PE', '0');
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (4, 'END. FATURAMENTO', '88813-900', 'Av. Manoel D. Freitas', '1001', NULL, 'PROSPERA', 'Criciúma', 'SC', '0');
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (5, 'END. LOJA', '12233-000', 'Av. Andrômeda', '3752', NULL, 'Bosque dos Eucaliptos', 'São José dos Campos', 'SP', '0');
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (6, NULL, '06543-260', 'Rua Cerejeira', '956', NULL, 'Condomínio Melville (Tamboré)', 'Santana de Parnaíba', 'SP', '0');
INSERT INTO `mydb`.`Endereco` (`idEndereco`, `descricao`, `CEP`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `used`) VALUES (7, 'END. FATURAMENTO', '87114-250 ', 'Avenida da Laguna', '1776', NULL, 'Jardim Independência III', 'Sarandi', 'PR', '0');
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Loja` (`idLoja`, `idEndereco`, `descricao`, `nomeFantasia`, `razaoSocial`, `tel`, `inscEstadual`, `sigla`, `cnpj`, `codUF`, `porcentagemFrete`, `valorMinimoFrete`) VALUES (1, 5, 'Loja 1', 'LOJA 01', 'LOJA 01 EPP', '(12)1234-5678', '000.000.000.000', 'LJ01', '19.261.391/0001-26', 35, DEFAULT, DEFAULT);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `idEnderecoFaturamento`, `idEnderecoCobranca`, `idEnderecoEntrega`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `pfpj`) VALUES (1, 'AMBOS', 'Marcos Oliveira Ferreira', 'Marcos', '41.875.789-6', '432.432.477-80', '00.696.325/0001-50', 'Betina e Isabelle Alimentos ME', 'Bisa Massas', '920.048.586.200', 1, 2, 3, '(11)2801-2013', '(11)2801-2013', '(11)2801-2013', '00*0000000*00000', '(11)2801-2013', 'LucasSousaRibeiro@teleworm.us ', 1, NULL, NULL, NULL, 'PJ');
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `idEnderecoFaturamento`, `idEnderecoCobranca`, `idEnderecoEntrega`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `pfpj`) VALUES (2, 'FORNECEDOR', 'Portinari', 'Portinari', '00.000.000-6', '000.000.000-80', '00.334.497/0001-84', 'CERAMICA PORTINARI S/A', 'Portinari', 'ISENTO', 4, 4, 4, '(48)3431-6333', NULL, NULL, NULL, NULL, 'contato@ceramicaportinari.com.br', NULL, NULL, NULL, NULL, 'PJ');
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `clienteFornecedor`, `nome`, `apelido`, `rg`, `cpf`, `cnpj`, `razaoSocial`, `nomeFantasia`, `inscEstadual`, `idEnderecoFaturamento`, `idEnderecoCobranca`, `idEnderecoEntrega`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `pfpj`) VALUES (3, 'CLIENTE', 'Eduardo Pinto de Oliveira', NULL, NULL, '116.875.908-00', '11.111.111/1111-11', 'Staccato Revestimentos', NULL, 'isento', 6, 6, 6, '(11)4153-0948', NULL, NULL, NULL, NULL, 'edu.oliv@globo.com', NULL, NULL, NULL, NULL, 'PF');
