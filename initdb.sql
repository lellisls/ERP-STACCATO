...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ViewVendas` (`idVenda` INT, `idLoja` INT, `idUsuario` INT, `idCliente` INT, `idEnderecoEntrega` INT, `idProfissional` INT, `data` INT, `subTotalBru` INT, `subTotalLiq` INT, `frete` INT, `descontoPorc` INT, `descontoReais` INT, `total` INT, `validade` INT, `status` INT, `idEnderecoFaturamento` INT);
