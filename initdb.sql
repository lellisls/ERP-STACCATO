...
CREATE TABLE IF NOT EXISTS `mydb`.`Produto` (
  ...
  `markupUpd` INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Orcamento` (
  ...
  `idEnderecoFaturamento` INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PedidoFornecedor` (
  ...
  INDEX `fk_PedidoFornecedor_Cliente1_idx` (`idCliente` ASC),
  INDEX `fk_PedidoFornecedor_Loja1_idx` (`idLoja` ASC),
  INDEX `fk_PedidoFornecedor_Usuario1_idx` (`idUsuario` ASC),
  UNIQUE INDEX `idPedido_UNIQUE` (`idPedido` ASC),
  INDEX `fk_PedidoFornecedor_Profissional1_idx` (`idProfissional` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`PedidoFornecedor_has_Produto` (
  ...
  INDEX `fk_PedidoFornecedor_has_Produto_Produto1_idx` (`idProduto` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`NFe_has_Itens` (
  ...
  INDEX `fk_NFe_has_Itens_NFe1_idx` (`idNFe` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`ContaAReceber_has_Produto` (
  ...
  `total` DOUBLE NULL,
  PRIMARY KEY (`idConta`, `idProduto`),
  INDEX `fk_ContaAReceber_has_Produto_Produto1_idx` (`idProduto` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Profissional_has_Endereco` (
  `idEndereco` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `idProfissional` INT UNSIGNED NULL,
  `descricao` VARCHAR(45) NULL,
  `cep` VARCHAR(10) NULL,
  `logradouro` VARCHAR(90) NULL,
  `numero` VARCHAR(45) NULL,
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `idCliente`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (1, NULL, 'Não há', '', '', '', '', '', '', '', 0);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `idCliente`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (2, 1, 'END. PAGAMENTO', '17521-270', 'Rua Antônio Asperti', '658', 'AP 1', 'Jardim Esplanada', 'Marília', 'SP', 0);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `idCliente`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (3, 1, 'END. ENTREGA', '54230-586', 'Rua Santa Ana', '14', '', 'Ur-06', 'Jaboatão dos Guararapes', 'PE', 0);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `idCliente`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (4, 1, 'END. FATURAMENTO', '88813-900', 'Av. Manoel D. Freitas', '1001', '', 'PROSPERA', 'Criciúma', 'SC', 0);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `idCliente`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (5, NULL, 'END. LOJA', '12233-000', 'Av. Andrômeda', '3752', '', 'Bosque dos Eucaliptos', 'São José dos Campos', 'SP', 0);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `idCliente`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (6, 3, 'RESIDENCIA', '06543-260', 'Rua Cerejeira', '956', '', 'Condomínio Melville (Tamboré)', 'Santana de Parnaíba', 'SP', 0);
INSERT INTO `mydb`.`Cliente_has_Endereco` (`idEndereco`, `idCliente`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (7, 2, 'END. FATURAMENTO', '87114-250 ', 'Avenida da Laguna', '1776', '', 'Jardim Independência III', 'Sarandi', 'PR', 0);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Loja_has_Endereco` (`idEndereco`, `idLoja`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (1, 1, 'Principal', '06473-000', 'Avenida Andrômeda', '900', NULL, 'Alphaville Empresarial', 'Barueri', 'SP', 0);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Profissional_has_Endereco` (`idEndereco`, `idProfissional`, `descricao`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `uf`, `desativado`) VALUES (1, NULL, 'Não há', '', '', '', '', '', '', '', 0);
