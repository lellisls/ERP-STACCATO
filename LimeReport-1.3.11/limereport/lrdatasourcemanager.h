...
public:
  ...
  explicit DataSourceModel(DataSourceManager *dataManager);
...
public:
  ...
  GroupFunction *addGroupFunction(const QString &name, const QString &expression, const QString &band,
...
protected:
  ...
  void addVariable(const QString &name, const QVariant &value, VarDesc::VarType type = VarDesc::User,
