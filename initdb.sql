...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_agendar_coleta` (`prazoEntrega` INT, `idEstoque` INT, `fornecedor` INT, `numeroNFe` INT, `idVenda` INT, `ordemCompra` INT, `local` INT, `Transportadora` INT, `produto` INT, `codComercial` INT, `quant` INT, `un` INT, `caixas` INT, `kgcx` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_calendario_carga` (`idEvento` INT, `dataPrevEnt` INT, `idVenda` INT, `status` INT, `count(0)` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_calendario_entrega`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_calendario_entrega` (`data` INT, `razaoSocial` INT, `modelo` INT, `placa` INT, `idVenda` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_calendario_produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_calendario_produto` (`idNfeSaida` INT, `idEvento` INT, `idVenda` INT, `idVendaProduto` INT, `fornecedor` INT, `produto` INT, `quant` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_caminhao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_caminhao` (`Transportadora` INT, `Veículo` INT, `Placa` INT, `Evento` INT, `Produtos` INT, `Status` INT, `Estoque` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_coleta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_coleta` (`prazoEntrega` INT, `dataPrevColeta` INT, `idEstoque` INT, `fornecedor` INT, `numeroNFe` INT, `idVenda` INT, `ordemCompra` INT, `local` INT, `Transportadora` INT, `produto` INT, `codComercial` INT, `quant` INT, `un` INT, `caixas` INT, `kgcx` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_conta_pagar` (`idPagamento` INT, `idLoja` INT, `contraparte` INT, `dataEmissao` INT, `ordemCompra` INT, `valor` INT, `tipo` INT, `parcela` INT, `dataPagamento` INT, `observacao` INT, `status` INT, `statusFinanceiro` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_conta_receber`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_conta_receber` (`idPagamento` INT, `idLoja` INT, `representacao` INT, `contraparte` INT, `dataEmissao` INT, `idVenda` INT, `valor` INT, `tipo` INT, `parcela` INT, `dataPagamento` INT, `observacao` INT, `status` INT, `statusFinanceiro` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_entrega`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_entrega` (`prazoEntrega` INT, `idVenda` INT, `Estoque` INT, `Entregue` INT, `Outros` INT, `Bairro` INT, `Logradouro` INT, `Número` INT, `Cidade` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_entrega_pendente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_entrega_pendente` (`prazoEntrega` INT, `statusFinanceiro` INT, `idVenda` INT, `Estoque` INT, `Entregue` INT, `Outros` INT, `Bairro` INT, `Logradouro` INT, `Número` INT, `Cidade` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_entrega_produtos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_entrega_produtos` (`idVendaProduto` INT, `idProduto` INT, `dataPrevEnt` INT, `status` INT, `fornecedor` INT, `idVenda` INT, `produto` INT, `caixas` INT, `quant` INT, `un` INT, `unCaixa` INT, `codComercial` INT, `formComercial` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_estoque`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_estoque` (`Status` INT, `idEstoque` INT, `Fornecedor` INT, `Produto` INT, `Quant Rest` INT, `Un` INT, `Un2` INT, `Caixas M2` INT, `Caixas PÇ` INT, `Cód Com` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_fluxo_caixa` (`Código` INT, `Loja` INT, `Data Pag` INT, `R$` INT, `Tipo` INT, `Status` INT, `ENTRADA/SAIDA` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_fluxo_resumo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_fluxo_resumo` (`Data Pag` INT, `SAIDA` INT, `ENTRADA` INT, `R$` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_followup_venda` (`idVenda` INT, `nome` INT, `observacao` INT, `dataFollowup` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_fornecedor_logistica_agendar_coleta` (`Fornecedor` INT, `COLET` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_logistica_representacao` (`prazoEntrega` INT, `idPedido` INT, `fornecedor` INT, `idVenda` INT, `ordemCompra` INT, `descricao` INT, `codComercial` INT, `quant` INT, `un` INT, `caixas` INT, `kgcx` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_nfe_entrada` (`NFe` INT, `OC` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_nfe_saida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_nfe_saida` (`NFe` INT, `OC` INT, `Venda` INT, `CPF` INT, `CNPJ` INT, `Cliente` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_orcamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_orcamento` (`idLoja` INT, `idUsuario` INT, `Status` INT, `Dias restantes` INT, `Código` INT, `Vendedor` INT, `Indicou` INT, `Cliente` INT, `Profissional` INT, `Tel` INT, `Cel` INT, `Tel Com` INT, `Data` INT, `Total` INT, `Data Próx Followup` INT, `Observação` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_ordemcompra_nfe` (`ordemCompra` INT, `numeroNFe` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_pedido_fornecedor_livre` (`idPedido` INT, `idVenda` INT, `idVendaProduto` INT, `ordemCompra` INT, `idCompra` INT, `descricao` INT, `quant` INT, `caixas` INT, `prcUnitario` INT, `codComercial` INT, `dataPrevCompra` INT, `dataRealCompra` INT, `dataPrevConf` INT, `status` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_produto_estoque` (`idVendaProduto` INT, `selecionado` INT, `status` INT, `idNfeSaida` INT, `fornecedor` INT, `idVenda` INT, `idLoja` INT, `idProduto` INT, `produto` INT, `obs` INT, `prcUnitario` INT, `descUnitario` INT, `caixas` INT, `quant` INT, `un` INT, `unCaixa` INT, `codComercial` INT, `formComercial` INT, `total` INT, `idCompra` INT, `estoque_promocao` INT, `dataPrevCompra` INT, `dataRealCompra` INT, `dataPrevConf` INT, `dataRealConf` INT, `dataPrevFat` INT, `dataRealFat` INT, `dataPrevColeta` INT, `dataRealColeta` INT, `dataPrevReceb` INT, `dataRealReceb` INT, `dataPrevEnt` INT, `dataRealEnt` INT, `codBarras` INT, `ncm` INT, `cfop` INT, `valorUnid` INT, `valor` INT, `codBarrasTrib` INT, `unTrib` INT, `quantTrib` INT, `valorTrib` INT, `desconto` INT, `compoeTotal` INT, `numeroPedido` INT, `itemPedido` INT, `tipoICMS` INT, `orig` INT, `cstICMS` INT, `modBC` INT, `vBC` INT, `pICMS` INT, `vICMS` INT, `modBCST` INT, `pMVAST` INT, `vBCST` INT, `pICMSST` INT, `vICMSST` INT, `cEnq` INT, `cstIPI` INT, `cstPIS` INT, `vBCPIS` INT, `pPIS` INT, `vPIS` INT, `cstCOFINS` INT, `vBCCOFINS` INT, `pCOFINS` INT, `vCOFINS` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_recebimento` (`prazoEntrega` INT, `dataPrevReceb` INT, `idEstoque` INT, `fornecedor` INT, `numeroNFe` INT, `idVenda` INT, `ordemCompra` INT, `local` INT, `produto` INT, `quant` INT, `un` INT, `caixas` INT, `codComercial` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_venda` (`idLoja` INT, `idUsuario` INT, `statusFinanceiro` INT, `dataFinanceiro` INT, `Status` INT, `statusEntrega` INT, `Dias restantes` INT, `Código` INT, `Vendedor` INT, `Indicou` INT, `Cliente` INT, `Profissional` INT, `Data` INT, `Total R$` INT, `Data Followup` INT, `Observação` INT);

-- -----------------------------------------------------
-- Placeholder table for view `mydb`.`view_venda_produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_venda_produto` (`status` INT, `statusFinanceiro` INT, `dataFinanceiro` INT, `data` INT, `fornecedor` INT, `idVenda` INT, `Vendedor` INT, `produto` INT, `caixas` INT, `quant` INT, `un` INT, `codComercial` INT, `formComercial` INT);
...
BEGIN 
    ...
    UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'DEVOLVIDO' AND v.status != 'CANCELADO';
    UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'PROCESSADO' AND v.status != 'CANCELADO';
    UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'ENTREGUE' AND v.status != 'CANCELADO';
	UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'EM ENTREGA' AND v.status != 'CANCELADO';
    UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'ENTREGA AGEND.' AND v.status != 'CANCELADO';
	UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'ESTOQUE'AND v.status != 'CANCELADO';
	UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'EM RECEBIMENTO'AND v.status != 'CANCELADO';
	UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'EM COLETA'AND v.status != 'CANCELADO';
	UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'EM FATURAMENTO'AND v.status != 'CANCELADO';
	UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'EM COMPRA'AND v.status != 'CANCELADO';
	UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'INICIADO'AND v.status != 'CANCELADO';
    UPDATE venda v, venda_has_produto vp SET v.status = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'PENDENTE'AND v.status != 'CANCELADO';
    
	UPDATE venda v, venda_has_produto vp SET v.statusEntrega = vp.status WHERE v.idVenda = vp.idVenda AND vp.status = 'ESTOQUE';    
...
VIEW `mydb`.`view_caminhao` AS
    SELECT 
        ...
        `thv`.`placa` AS `Placa`,
        `vhp`.`idEvento` AS `Evento`,
        COUNT(`vhp`.`idEvento`) AS `Produtos`,
        `vhp`.`status` AS `Status`,
        GROUP_CONCAT(DISTINCT `vhp`.`idEstoque`
            SEPARATOR ',') AS `Estoque`
    FROM
        ((`mydb`.`veiculo_has_produto` `vhp`
        LEFT JOIN `mydb`.`transportadora_has_veiculo` `thv` ON ((`vhp`.`idVeiculo` = `thv`.`idVeiculo`)))
...
VIEW `mydb`.`view_conta_receber` AS
    ...
    FROM
        ...
        LEFT JOIN `mydb`.`pedido_fornecedor_has_produto` `pf` ON ((`cr`.`idVenda` = `pf`.`idVenda`)))
    WHERE
        (`cr`.`representacao` = 0)
...
VIEW `mydb`.`view_financeiro` AS
    SELECT 
        ...
        (SUM(IF(ISNULL(`mydb`.`estoque_has_consumo`.`valorUnid`),
            (`pedidofornecedorreduzido`.`prcUnitario` * `mydb`.`venda_has_produto`.`quant`),
            ((`mydb`.`venda_has_produto`.`quant` * (1 - (`mydb`.`estoque_has_consumo`.`desconto` / `mydb`.`estoque_has_consumo`.`valor`))) * `mydb`.`estoque_has_consumo`.`valorUnid`))) + 0E0) AS `custo`,
        IF((ISNULL(`mydb`.`estoque_has_consumo`.`valorUnid`)
        ...
        (SUM(IF(((RIGHT(`mydb`.`venda_has_produto`.`idVenda`,
                ...
                2) = 'RD')),
            0,
            ((0.58 * 0.12) * IF(ISNULL(`mydb`.`estoque_has_consumo`.`valorUnid`),
                (`pedidofornecedorreduzido`.`prcUnitario` * `mydb`.`venda_has_produto`.`quant`),
                (`mydb`.`venda_has_produto`.`quant` * `mydb`.`estoque_has_consumo`.`valorUnid`))))) + 0E0) AS `ICMS`,
        SUM(IF(((RIGHT(`mydb`.`venda_has_produto`.`idVenda`,
                1) = 'R')
                OR (RIGHT(`mydb`.`venda_has_produto`.`idVenda`,
                2) = 'RD')),
    ...
    FROM
        ...
        GROUP BY `mydb`.`pedido_fornecedor_has_produto`.`idCompra` , `mydb`.`pedido_fornecedor_has_produto`.`idProduto` , `mydb`.`pedido_fornecedor_has_produto`.`prcUnitario`) `pedidofornecedorreduzido` ON (((`mydb`.`venda_has_produto`.`idProduto` = `pedidofornecedorreduzido`.`idProduto`)
        ...
        LEFT JOIN (SELECT 
            SUM(IF(((`mydb`.`conta_a_receber_has_pagamento`.`tipo` LIKE '%Taxa Cartão')
                    AND (`mydb`.`conta_a_receber_has_pagamento`.`valor` IS NOT NULL)), (-(1) * `mydb`.`conta_a_receber_has_pagamento`.`valor`), 0E0)) AS `Cartao`,
    ...
    GROUP BY DATE_FORMAT(`mydb`.`venda`.`data`, '%Y-%m') , `mydb`.`loja`.`nomeFantasia` , IF((ISNULL(`mydb`.`estoque_has_consumo`.`valorUnid`)
            AND ISNULL(`pedidofornecedorreduzido`.`prcUnitario`)
            AND (RIGHT(`mydb`.`venda_has_produto`.`idVenda`,
            1) <> 'R')
            AND (RIGHT(`mydb`.`venda_has_produto`.`idVenda`,
...
VIEW `mydb`.`view_fluxo_caixa` AS
    SELECT 
        `cp`.`idCompra` AS `Código`,
        (SELECT 
                `mydb`.`loja`.`nomeFantasia`
            FROM
                `mydb`.`loja`
            WHERE
                (`mydb`.`loja`.`idLoja` = `cp`.`idLoja`)) AS `Loja`,
        `cp`.`dataPagamento` AS `Data Pag`,
        (`cp`.`valor` * -(1)) AS `R$`,
        `cp`.`tipo` AS `Tipo`,
        `cp`.`status` AS `Status`,
        'SAIDA' AS `ENTRADA/SAIDA`
    FROM
        `mydb`.`conta_a_pagar_has_pagamento` `cp` 
    UNION SELECT 
        `cr`.`idVenda` AS `idVenda`,
        (SELECT 
            ...
            FROM
                `mydb`.`loja`
            WHERE
                (`mydb`.`loja`.`idLoja` = `cr`.`idLoja`)) AS `Name_exp_9`,
        `cr`.`dataPagamento` AS `dataPagamento`,
        `cr`.`valor` AS `valor`,
        `cr`.`tipo` AS `tipo`,
        `cr`.`status` AS `status`,
...
VIEW `mydb`.`view_fluxo_resumo` AS
    SELECT 
        `view_fluxo_caixa`.`Data Pag` AS `Data Pag`,
        SUM((CASE
            WHEN (`view_fluxo_caixa`.`ENTRADA/SAIDA` = 'SAIDA') THEN `view_fluxo_caixa`.`R$`
            ELSE 0
        END)) AS `SAIDA`,
        SUM((CASE
            WHEN (`view_fluxo_caixa`.`ENTRADA/SAIDA` = 'ENTRADA') THEN `view_fluxo_caixa`.`R$`
            ELSE 0
        END)) AS `ENTRADA`,
        SUM(`view_fluxo_caixa`.`R$`) AS `R$`
    FROM
        `mydb`.`view_fluxo_caixa`
    GROUP BY `view_fluxo_caixa`.`Data Pag`
    ORDER BY `view_fluxo_caixa`.`Data Pag`;
...
VIEW `mydb`.`view_fornecedor_compra` AS
    SELECT 
        ...
        SUM((`mydb`.`pedido_fornecedor_has_produto`.`status` = 'PENDENTE')) AS `PEND`,
        SUM((`mydb`.`pedido_fornecedor_has_produto`.`status` = 'EM COMPRA')) AS `CONF`,
        SUM((`mydb`.`pedido_fornecedor_has_produto`.`status` = 'EM FATURAMENTO')) AS `FAT`
    FROM
        `mydb`.`pedido_fornecedor_has_produto`
    WHERE
...
VIEW `mydb`.`view_nfe_entrada` AS
    SELECT 
        `n`.`numeroNFe` AS `NFe`,
        GROUP_CONCAT(DISTINCT `e`.`ordemCompra`
            ORDER BY `e`.`ordemCompra` ASC
            SEPARATOR ',') AS `OC`
    FROM
        ((`mydb`.`nfe` `n`
        LEFT JOIN `mydb`.`estoque_has_nfe` `ehn` ON ((`n`.`idNFe` = `ehn`.`idNFe`)))
...
CREATE 
    ...
    DEFINER = `root`@`localhost` 
    SQL SECURITY DEFINER
VIEW `view_ordemcompra_nfe` AS
    SELECT DISTINCT
        `pf`.`ordemCompra` AS `ordemCompra`,
        `n`.`numeroNFe` AS `numeroNFe`
    FROM
        (((`nfe` `n`
        LEFT JOIN `estoque_has_nfe` `ehn` ON ((`n`.`idNFe` = `ehn`.`idNFe`)))
        LEFT JOIN `estoque_has_compra` `ehc` ON ((`ehc`.`idEstoque` = `ehn`.`idEstoque`)))
        LEFT JOIN `pedido_fornecedor_has_produto` `pf` ON ((`pf`.`idCompra` = `ehc`.`idCompra`)))
    WHERE
        (`pf`.`ordemCompra` IS NOT NULL);
...
VIEW `mydb`.`view_produto_estoque` AS
    SELECT 
        ...
        `vp`.`produto` AS `produto`,
        `vp`.`obs` AS `obs`,
        `vp`.`prcUnitario` AS `prcUnitario`,
        `vp`.`descUnitario` AS `descUnitario`,
        `vp`.`caixas` AS `caixas`,
        `vp`.`quant` AS `quant`,
        `vp`.`un` AS `un`,
        ...
        `vp`.`estoque_promocao` AS `estoque_promocao`,
        `vp`.`dataPrevCompra` AS `dataPrevCompra`,
        `vp`.`dataRealCompra` AS `dataRealCompra`,
        `vp`.`dataPrevConf` AS `dataPrevConf`,
        `vp`.`dataRealConf` AS `dataRealConf`,
        `vp`.`dataPrevFat` AS `dataPrevFat`,
...
-- -----------------------------------------------------
-- View `mydb`.`view_temp_estoque`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `mydb`.`view_temp_estoque` ;
DROP TABLE IF EXISTS `mydb`.`view_temp_estoque`;
USE `mydb`;
CREATE 
     OR REPLACE ALGORITHM = UNDEFINED 
    DEFINER = `root`@`localhost` 
    SQL SECURITY DEFINER
VIEW `mydb`.`view_temp_estoque` AS
    SELECT 
        `e`.`idEstoque` AS `idEstoque`,
        `e`.`status` AS `status`,
        `e`.`ordemCompra` AS `ordemCompra`,
        ...
        `e`.`quant` AS `quant`,
        `e`.`quantUpd` AS `quantUpd`,
        `e`.`un` AS `un`,
        `e`.`caixas` AS `caixas`,
        `e`.`codBarras` AS `codBarras`,
        `e`.`codComercial` AS `codComercial`,
        `e`.`ncm` AS `ncm`,
        `e`.`cfop` AS `cfop`,
        `e`.`valorUnid` AS `valorUnid`,
        `e`.`valor` AS `valor`,
        `e`.`codBarrasTrib` AS `codBarrasTrib`,
        `e`.`unTrib` AS `unTrib`,
        `e`.`quantTrib` AS `quantTrib`,
        `e`.`valorTrib` AS `valorTrib`,
        `e`.`desconto` AS `desconto`,
        `e`.`compoeTotal` AS `compoeTotal`,
        `e`.`numeroPedido` AS `numeroPedido`,
        `e`.`itemPedido` AS `itemPedido`,
        `e`.`tipoICMS` AS `tipoICMS`,
        `e`.`orig` AS `orig`,
        `e`.`cstICMS` AS `cstICMS`,
        `e`.`modBC` AS `modBC`,
        `e`.`vBC` AS `vBC`,
        `e`.`pICMS` AS `pICMS`,
        `e`.`vICMS` AS `vICMS`,
        `e`.`modBCST` AS `modBCST`,
        `e`.`pMVAST` AS `pMVAST`,
        `e`.`vBCST` AS `vBCST`,
        `e`.`pICMSST` AS `pICMSST`,
        `e`.`vICMSST` AS `vICMSST`,
        `e`.`cEnq` AS `cEnq`,
        `e`.`cstIPI` AS `cstIPI`,
        `e`.`cstPIS` AS `cstPIS`,
        `e`.`vBCPIS` AS `vBCPIS`,
        `e`.`pPIS` AS `pPIS`,
        `e`.`vPIS` AS `vPIS`,
        `e`.`cstCOFINS` AS `cstCOFINS`,
        `e`.`vBCCOFINS` AS `vBCCOFINS`,
        `e`.`pCOFINS` AS `pCOFINS`,
        `e`.`vCOFINS` AS `vCOFINS`,
        `e`.`created` AS `created`,
        `e`.`lastUpdated` AS `lastUpdated`
    FROM
        (((`mydb`.`estoque` `e`
        LEFT JOIN `mydb`.`estoque_has_compra` `ehcomp` ON ((`e`.`idEstoque` = `ehcomp`.`idEstoque`)))
        LEFT JOIN `mydb`.`estoque_has_consumo` `ehcons` ON ((`e`.`idEstoque` = `ehcons`.`idEstoque`)))
        LEFT JOIN `mydb`.`pedido_fornecedor_has_produto` `pf` ON (((`ehcomp`.`idCompra` = `pf`.`idCompra`)
            AND (`e`.`codComercial` = `pf`.`codComercial`)
            AND (`e`.`quant` = `pf`.`quant`))))
    WHERE
        (ISNULL(`ehcons`.`idEstoque`)
            AND (`pf`.`idPedido` IS NOT NULL))
    GROUP BY `e`.`idEstoque`;
