...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`view_recebimento` (`fornecedor` INT, `numeroNFe` INT, `produto` INT, `quant` INT, `un` INT, `caixas` INT, `idVenda` INT, `ordemCompra` INT, `local` INT, `dataRealCompra` INT, `dataRealConf` INT, `dataRealFat` INT, `dataPrevColeta` INT);
