...
public:
  explicit Marker(QGraphicsItem *parent = 0) : QGraphicsItem(parent) {}
...
public:
  explicit SelectionMarker(QGraphicsItem *parent = 0);
...
class BaseDesignIntf : public QObject,
...
public:
  ...
  enum BorderSide { TopLine = 1, BottomLine = 2, LeftLine = 4, RightLine = 8 };
...
public:
  ...
  virtual BaseDesignIntf *cloneItemWOChild(LimeReport::BaseDesignIntf::ItemMode mode, QObject *owner = 0,
                                           QGraphicsItem *parent = 0);
