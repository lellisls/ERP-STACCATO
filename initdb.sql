...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`cliente` (`idCliente`, `pfpj`, `nome_razao`, `nomeFantasia`, `cpf`, `cnpj`, `dataNasc`, `inscEstadual`, `contatoNome`, `contatoCPF`, `contatoApelido`, `contatoRG`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `desativado`, `created`, `lastUpdated`) VALUES (1, 'PJ', 'Eduardo Pinto de Oliveira', NULL, NULL, '11.111.111/1111-11', NULL, 'ISENTO', NULL, NULL, NULL, NULL, '(11)4153-0948', NULL, NULL, NULL, NULL, 'edu.oliv@globo.com', NULL, NULL, NULL, 0, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO `mydb`.`cliente` (`idCliente`, `pfpj`, `nome_razao`, `nomeFantasia`, `cpf`, `cnpj`, `dataNasc`, `inscEstadual`, `contatoNome`, `contatoCPF`, `contatoApelido`, `contatoRG`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`, `desativado`, `created`, `lastUpdated`) VALUES (2, 'PF', 'Rodrigo Torres Alves', NULL, '927.636.342-49', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, DEFAULT, DEFAULT, DEFAULT);
