...
TextAlignmentEditorWidget::TextAlignmentEditorWidget(ReportDesignWidget *reportEditor, const QString &title,
                                                     QWidget *parent)
...
void TextAlignmentEditorWidget::initEditor() {
  ...
  if (reportEditor()) {
    connect(reportEditor(), &ReportDesignWidget::itemPropertyChanged, this,
            &TextAlignmentEditorWidget::slotPropertyChanged);
  }
  if (page()) {
...
void TextAlignmentEditorWidget::slotPropertyChanged(const QString &objectName, const QString &property,
                                                    const QVariant &oldValue, const QVariant &newValue) {
  Q_UNUSED(oldValue)
  Q_UNUSED(newValue)

  if (item() and (item()->objectName() == objectName) and (property == "alignment")) {
