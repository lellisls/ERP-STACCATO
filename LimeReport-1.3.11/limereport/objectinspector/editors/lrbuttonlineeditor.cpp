...
ButtonLineEditor::ButtonLineEditor(const QString &propertyName, QWidget *parent)
  ...
  connect(m_buttonEdit, &QAbstractButton::clicked, this, &ButtonLineEditor::editButtonClicked);
}
...
void ButtonLineEditor::editButtonClicked() {
  ...
  connect(editor, &QDialog::accepted, this, &ButtonLineEditor::editingByEditorFinished);
  editor->exec();
}
