...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Cadastro` (`idCadastro`, `pfpj`, `clienteFornecedor`, `nome_razao`, `nomeFantasia`, `cpf`, `cnpj`, `rg`, `inscEstadual`, `contatoNome`, `contatoCPF`, `contatoApelido`, `contatoRG`, `tel`, `telCel`, `telCom`, `idNextel`, `nextel`, `email`, `idUsuarioRel`, `idCadastroRel`, `idProfissionalRel`, `incompleto`) VALUES (1, 'PJ', 'CLIENTE', 'Marcos Oliveira Ferreira', 'Bisa Massas', '432.432.477-80', '00.696.325/0001-50', '41.875.789-6', '920.048.586.200', NULL, NULL, NULL, NULL, '(11)2801-2013', '(11)2801-2013', '(11)2801-2013', '00*0000000*00000', '(11)2801-2013', 'LucasSousaRibeiro@teleworm.us ', NULL, NULL, NULL, 0);
