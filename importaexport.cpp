    ...
    while (queryProd.next()) {
      ...
      if (!fornecedor.isEmpty()) {
        ...
        qryInsert.prepare(
              ...
              "m2cx, pccx, kgcx, formComercial, codComercial, codBarras, ncm, icms, situacaoTributaria, "
              "qtdPallet, "
              "custo, ipi, st, precoVenda, comissao, observacoes, origem, descontinuado, temLote, ui"
              ") VALUES "
              ...
              ":observacoes, :origem, :descontinuado, :temLote, :ui)");
        ...
        if (!qryInsert.exec()) {
          ...
          qDebug() << "unidade: " << unidade;
          qDebug() << "colecao: " << colecao;
          qDebug() << "m2cx: " << m2cx;
          qDebug() << "pccx: " << pccx;
          qDebug() << "kgcx: " << kgcx;
          qDebug() << "formatoCom: " << formatoCom;
          qDebug() << "codCom: " << codCom;
          qDebug() << "codBarras: " << codBarras;
          qDebug() << "ncm: " << ncm;
          qDebug() << "icms: " << icms;
          qDebug() << "situacaoTrib: " << situacaoTrib;
